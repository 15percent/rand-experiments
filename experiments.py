...
def rand_func_1():
	rand_list = [random.random() for x in range(0, 1000000)]
...
def rand_func_2():
	rand_list = [(random.random() + random.random()/2) for x in range(0, 1000000)]
	update_list = [int(x/0.05) for x in rand_list]
...
def rand_func_3():
	rand_list = [random.random()*random.random() for x in range(0, 1000000)]
	update_list = [int(x/0.05) for x in rand_list]
